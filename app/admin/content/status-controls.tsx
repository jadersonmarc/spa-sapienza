  ...
  return (
    <div className="flex flex-col gap-3 rounded-md border border-white/10 p-4">
      <div className="flex items-center gap-2 text-sm">
        ...
        <span className="rounded-full bg-white/10 px-2.5 py-0.5 text-xs font-medium uppercase">
          {STATUS_LABEL[status]}
        </span>
      </div>
              ...
              <form key={to} action={formAction} className="flex items-end gap-2">
                ...
                <label className="flex flex-col gap-1 text-xs text-muted-foreground">
                  ...
                  <input
                    ...
                    required
                    className="rounded-md border border-white/10 bg-background px-2 py-1.5 text-sm text-foreground outline-none focus:border-white/30"
                  />
                </label>
